...
Solar zenith angle is then calculated across all grid cells and time steps using the pycontrails in-built SZA calculator function \cite{pycontrails_sza}. Knowledge of these meteorological parameters is crucial for estimating the photochemical and microphysical evolution of an aircraft plume and its associated emissions masses.
