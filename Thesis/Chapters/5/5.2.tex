...
\begin{landscape}
    \begin{figure}[htbp]
        ...
        \caption{GPAT process flow schematic portraying the input parameters (rhombi), constituent models (boxes) and flow of data through a range of datasets (cylinders).}
        %\vspace{-0.5cm}
        \label{gpat_diag}
    \end{figure}
\end{landscape}