...
#include "pathsetup.finc"
        !Makefile creates a line like this: IERR = NF90_OPEN('/home/ktait98/pycontrails_kt/pycontrails/models/files/boxm_ds.nc', NF90_WRITE, NCID)
#endif
        IF (IERR /= NF90_NOERR) THEN
