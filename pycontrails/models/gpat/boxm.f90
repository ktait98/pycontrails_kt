MODULE BOXM
    ...
    INTEGER, ALLOCATABLE :: SPECIES_OUT(:)
...
CONTAINS 
    ...
    SUBROUTINE GET_DIMS
        ...
        IERR = NF90_INQUIRE_ATTRIBUTE(NCID, NF90_GLOBAL, "species_out", LEN=NS_OUT)
    ...
    SUBROUTINE INIT_VARS
        ...
        IF (.NOT. ALLOCATED(Y_PPB)) THEN
            ...
            Y_PPB(:,:) = 0.0
        END IF
        IF (.NOT. ALLOCATED(SPECIES_OUT)) THEN
            ALLOCATE(SPECIES_OUT(NS_OUT))
            SPECIES_OUT(:) = 0
        END IF
