MODULE BOXM
    ...
    INTEGER :: NTC, NPC, NPP, NFL
    INTEGER :: S, CELL, TS
    INTEGER :: I, SPECIES_INDEX, JOBID 

    INTEGER :: NCID, DIMID_TIME, DIMID_CELL, DIMID_NS
    ...
    INTEGER, PRIVATE :: VARID_SPECIES, VARID_BG_CHEM
    INTEGER, PRIVATE :: VARID_TEMP, VARID_M, VARID_H2O, VARID_O2, VARID_N2, VARID_SZA
    ...
    DOUBLE PRECISION, ALLOCATABLE :: BG_CHEM(:,:)
