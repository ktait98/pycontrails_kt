...
if [ $sep_dist == "0_2" ]; then
   ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac 2 --sep_dist "0,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_2_0_0_6_0.01_0.05"
elif [ $sep_dist == "0_3_5" ]; then
   for n_ac in "${n_ac1[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "0,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_0_0_6_0.01_0.05"
   done
elif [ $sep_dist == "0_10" ]; then
   for n_ac in "${n_ac2[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "0,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_0_0_6_0.01_0.05"
   done
elif [ $sep_dist == "100_3_5" ]; then
   for n_ac in "${n_ac1[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "100,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_100_0_6_0.01_0.05"
   done
elif [ $sep_dist == "100_10" ]; then
   for n_ac in "${n_ac2[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "100,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_100_0_6_0.01_0.05"
   done
elif [ $sep_dist == "500_3_5" ]; then
   for n_ac in "${n_ac1[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "500,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_500_0_6_0.01_0.05"
   done
elif [ $sep_dist == "500_10" ]; then
   for n_ac in "${n_ac2[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "500,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_500_0_6_0.01_0.05"
   done
elif [ $sep_dist == "1000_3_5" ]; then
   for n_ac in "${n_ac1[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "1000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_1000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "1000_10" ]; then
   for n_ac in "${n_ac2[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "1000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_1000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "2000_3_5" ]; then
   for n_ac in "${n_ac1[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "2000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_2000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "2000_10" ]; then
   for n_ac in "${n_ac2[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "2000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_2000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "3000_3_5" ]; then
   for n_ac in "${n_ac1[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "3000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_3000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "3000_10" ]; then
   for n_ac in "${n_ac2[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "3000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_3000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "5000_3_5" ]; then
   for n_ac in "${n_ac1[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "5000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_5000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "5000_10" ]; then
   for $n_ac in "${n_ac2[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --sep_dist "5000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_5000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "10000_3_5" ]; then
   for n_ac in "${n_ac1[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --rt_fl 200 --sep_dist "10000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_10000_0_6_0.01_0.05"
   done
elif [ $sep_dist == "10000_10" ]; then
   for n_ac in "${n_ac2[@]}"; do
      ./run_gpat_sensitivity.py --lat_bounds "47.0,48.0" --lon_bounds " -33.0,-32.0" --alt_bounds "12000,13000" --fl0_coords0 "47.5,-33.0,12500" --t0_sim "2022-01-20T12:00:00" \
                           --n_ac $n_ac --rt_fl 200 --sep_dist "10000,0,0" --max_age 6 --run_gpat --job_id "sensitivity_NA_${n_ac}_10000_0_6_0.01_0.05"
   done
fi